...
public class VertexCover {
    ...
    public static int vertexCover(int n, int m, int[][] edges) {
        ...
        // Here i represents a counter where every set bits j, (2 ^ j)th vertex is taken
        ...
        for (int i = 0; i < (1 << n); i++) {
            ...
            // Candidate for vertex cover and if it is min include it in ans
            ...
            if (totalEdge == 0) {
                // finding set bits to count no of vertices in current vertex cover
    ...
    public static void main(String[] args) {
        ...
        int[][] edges = { { 1, 2 },
                ...
                { 5, 2 },
                { 1, 3 } };
        System.out.println("Vertex Cover: " + vertexCover(N, M, edges));
    }
}
